# loopy — iteration 3 of 6 in loop "make-fizzbuzz-pass-its-tests"
...
In iteration 2, verifier stage `verify` failed. Output tail:

```text
fizzbuzz(15): want fizzbuzz, got number
```
